...
export const SistemaReducer = createReducer(
  ...
  on(sistemaActions.SetModalReadOnly, (state,{id})=> ({...state, modal:{ ...state.modal, title:'Consulta de Sistema', isLoading:true, type:FormType.CONSULTAR, codigoOpcion:id}})),
  on(sistemaActions.SetModalEditar, (state,{id})=> ({...state, modal:{ ...state.modal, title:'Editar Sistema ', isLoading:true, type:FormType.EDITAR, codigoOpcion:id}})),
  on(sistemaActions.CargarDataModalSuccess, (state,{sistema})=> ({...state, modal:{ ...state.modal, form: Sistema.createSistema(sistema.nombre, sistema.icono, sistema.url, sistema.puerto, sistema.imagen), isLoading:false}})),
